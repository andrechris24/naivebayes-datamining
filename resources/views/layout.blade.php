...
<body onload="switchvalidation()">
	<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
		<a class="navbar-brand me-lg-5" href="{{route('home')}}">
			<img class="navbar-brand-dark" src="{{asset('assets/img/data-mining_8438890.png')}}" alt="Data Mining logo" />
			<img class="navbar-brand-light" src="{{asset('assets/img/data-mining_8438890.png')}}" alt="Data Mining logo" />
		</a>
					...
					<ul class="navbar-nav align-items-center">
						<li class="nav-item dropdown ms-lg-3">
							...
							<div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
								<a class="dropdown-item d-flex align-items-center" href="{{route('profil.edit')}}">
