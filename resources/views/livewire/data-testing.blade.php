...
<div>
	...
	<div class="card">
		<div class="card-body">
			<div wire:ignore.self class="modal fade" tabindex="-1" id="modalAddTesting" aria-labelledby="modalAddTestingLabel" role="dialog"
						...
						<div class="modal-body">
							<form id="addNewTestingForm" wire:submit="store">
								...
								<div class="form-floating mb-3">
									<input type="text" class="form-control @error('nama') is-invalid @enderror " id="testName" wire:model="nama" placeholder="Nama" required />
								...
								<div class="form-floating mb-3" data-bs-toggle="tooltip" title="{{$attr->desc}}">
									...
									<input type="number" class="form-control @error('q.'.$attr->slug) is-invalid @enderror " min="0" wire:model="q.{{$attr->slug}}"
										id="test-{{$attr->slug}}" placeholder="123" required>
									@else
									<select wire:model="q.{{$attr->slug}}" class="form-select @error('q.'.$attr->slug) is-invalid @enderror " id="test-{{$attr->slug}}" required>
								...
								@endforeach
								<div class="form-floating mb-3">
									<select wire:model="status" class="form-select @error('status') is-invalid @enderror " id="testResult" required>
										<option value="">Pilih</option>
			...
			<div wire:ignore.self class="modal fade" tabindex="-1" id="modalImportTesting" aria-labelledby="modalImportTestingLabel"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form id="importTestingData" wire:submit="upload">
								<input type="file" class="form-control @error('dataset') is-invalid @enderror " id="testData" wire:model="dataset" aria-describedby="importFormats"
			...
			<div wire:ignore.self class="modal fade" tabindex="-1" id="modalClearTesting" aria-labelledby="modalClearTestingLabel"
				data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
					<div class="modal-content">
				...
				{ //Aksi
					...
					render: function (data, type, full) {
						return ('<div class="btn-group btn-group-sm" role="group">' +
							`<button class="btn btn-primary edit-record" wire:click="edit(${data})" data-bs-toggle="modal" data-bs-target="#modalAddTesting">` +
