...
<div>
	...
	<div class="card">
		<div class="card-body">
			<div wire:ignore.self class="modal fade" tabindex="-1" id="modalAddTraining"
				aria-labelledby="modalAddTrainingLabel" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog"
				aria-hidden="true">
						...
						<div class="modal-body">
							<form id="addNewTrainingForm" wire:submit="store">
								...
								<div class="form-floating mb-3">
									<input type="text" class="form-control @error('nama') is-invalid @enderror " id="trainName"
								...
								<div class="form-floating mb-3" data-bs-toggle="tooltip" title="{{$attr->desc}}">
									...
									<input type="number" class="form-control @error('q.'.$attr->slug) is-invalid @enderror "
										min="0" wire:model="q.{{$attr->slug}}" placeholder="123" id="train-{{$attr->slug}}"
										required>
									@else
									<select wire:model="q.{{$attr->slug}}"
										class="form-select @error('q.'.$attr->slug) is-invalid @enderror "
			...
			<div wire:ignore.self class="modal fade" tabindex="-1" id="modalImportTraining"
				aria-labelledby="modalImportTrainingLabel" data-bs-backdrop="static" data-bs-keyboard="false"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form id="importTrainingData" wire:submit="upload">
								<input type="file" class="form-control @error('dataset') is-invalid @enderror " id="trainData"
									data-bs-toggle="tooltip" wire:model="dataset" title="Format: xls, xlsx, csv, dan tsv"
									aria-describedby="importFormats"
						...
						<div class="modal-footer">
							<div wire:loading wire:target="upload" class="spinner-grow text-success me-3 d-none"
								role="status">
			...
			<div wire:ignore.self class="modal fade" tabindex="-1" id="modalClearTraining"
				aria-labelledby="modalClearTrainingLabel" data-bs-backdrop="static" data-bs-keyboard="false"
				role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Anda akan menghapus semua data testing yang akan mereset hasil klasifikasi terkait dan mereset
								probabilitas.</p>
						</div>
						<div class="modal-footer">
			...
			<div class="btn-group mb-2" role="group">
				...
				<button type="button" class="btn btn-danger" data-bs-toggle="modal"
					data-bs-target="#modalClearTraining">
				...
				{ //Aksi
					...
					render: function (data, type, full) {
						return ('<div class="btn-group btn-group-sm" role="group">' +
							`<button class="btn btn-primary" wire:click="edit(${data})" data-bs-toggle="modal" data-bs-target="#modalAddTraining">` +
							'<i class="fas fa-pen-to-square"></i>' +
							'</button>' +
							`<button class="btn btn-danger delete-record" wire:click="destroy(${data})" wire:confirm="Hapus data training ${full['nama']}?">` +
