	...
	<form enctype="multipart/form-data" id="form-edit-account" wire:submit="update">
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<input class="form-control @error('name') is-invalid @enderror " id="name" type="text"
						placeholder="Masukkan Nama Anda" wire:model="name" required>
					@error('name')
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<input class="form-control @error('email') is-invalid @enderror " id="email" type="email"
						placeholder="email@example.com" wire:model="email" required>
					@error('email')
					<div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
		...
		<div class="form-group position-relative mb-3">
			<div class="row">
				...
				<div class="col-lg-9">
					<input class="form-control @error('current_password') is-invalid @enderror " id="password-current"
						type="password" minlength="8" maxlength="20" placeholder="Password Anda"
		...
		<div class="form-group position-relative mb-3">
			<div class="row">
				...
				<div class="col-lg-9">
					<input class="form-control @error('password') is-invalid @enderror " id="newpassword" type="password"
		...
		<div class="form-group position-relative mb-3">
			<div class="row">
				...
				<div class="col-lg-9">
					<input class="form-control @error('password_confirmation') is-invalid @enderror " id="conf-password"
						type="password" minlength="8" maxlength="20" placeholder="Konfirmasi password baru"
				...
				<div class="modal-body">
					...
					<form id="DelAkunForm" wire:submit="delete">
						<input type="password" class="form-control @error('confirm_pass') is-invalid @enderror "
							wire:model="confirm_pass" placeholder="Password Anda" minlength="8" maxlength="20" required>
						@error('confirm_pass')
						<div class="invalid-feedback">{{$message}}</div>
						@enderror
					</form>
